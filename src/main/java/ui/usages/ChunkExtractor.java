...
public class ChunkExtractor {
    private static final Logger LOG = Logger.getInstance("#util.ChunkExtractor");
    ...
    private static final ThreadLocal<WeakFactory<Map<PsiFile, ChunkExtractor>>> ourExtractors = ThreadLocal.withInitial(() -> new WeakFactory<Map<PsiFile, ChunkExtractor>>() {
        @NotNull
        @Override
